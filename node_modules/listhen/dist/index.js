...
async function listen(handle, opts = {}) {
  ...
  if (opts.clipboard) {
    const clipboardy = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('clipboardy')); });
  ...
  const _open = async () => {
    const {default: open} = await Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require('open')); });

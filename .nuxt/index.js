...
import nuxt_plugin_plugin_3ee65809 from 'nuxt_plugin_plugin_3ee65809' // Source: ./components/plugin.js (mode: 'all')
import nuxt_plugin_pluginclient_a5da78d8 from 'nuxt_plugin_pluginclient_a5da78d8' // Source: ./cloudinary/plugin.client.js (mode: 'client')
import nuxt_plugin_pluginserver_12cc351c from 'nuxt_plugin_pluginserver_12cc351c' // Source: ./cloudinary/plugin.server.js (mode: 'server')
import nuxt_plugin_image_17d6f4cc from 'nuxt_plugin_image_17d6f4cc' // Source: ./image.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"titleTemplate":"Mastering Nuxt: %s","htmlAttrs":{"lang":"en"},"bodyAttrs":{"class":["my-style"]},"meta":[{"charset":"utf8"}],"link":[],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_3ee65809 === 'function') {
    await nuxt_plugin_plugin_3ee65809(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_pluginclient_a5da78d8 === 'function') {
    await nuxt_plugin_pluginclient_a5da78d8(app.context, inject)
  }

  if (process.server && typeof nuxt_plugin_pluginserver_12cc351c === 'function') {
    await nuxt_plugin_pluginserver_12cc351c(app.context, inject)
  }

  if (typeof nuxt_plugin_image_17d6f4cc === 'function') {
    await nuxt_plugin_image_17d6f4cc(app.context, inject)
  }
